...
void InitSetup(Metronome *metronome, MIX_Mixer *mixer) {
  ...
  setPlayerSound(metronome->player->track,
                 "/Users/seppedornon/Desktop/metronome/sounds/metronome1.mp3",
                 mixer);
  ...
  metronome->font = TTF_OpenFont(
      "/Users/seppedornon/Desktop/metronome/fonts/Roboto-Black.ttf", TEXT_SIZE);
  if (!metronome->font) {
